...
**Quick update:** I ended up choosing to drop Web Development, so I'm only taking Discrete Structures now. As soon as I started reading the Discrete Structures textbook, I realized that I would enjoy the course a lot more if I only committed to one class. Web Development is said to be not a big time commitment, and I'm sure I could have handled both, but I'd rather have more free time to relax, have a social life, do non-code-related things, and work on self-directed code projects. I'll likely take Web Development in the summer, since the summer term is a few weeks shorter at OSU, so I want to take a class that I expect to be easy. 
